...
export function getDimensaoSVG(dimensao: Dimensao, size = 32): string {
  const svgs: Record<Dimensao, string> = {
    ...
    artistica: `<svg width="${size}" height="${size}" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 26L8 18L22 6L26 10L12 24L6 26Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M18 8L24 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  };
